        ...
        n = {
          init: function () {
            ...
            "" !== a.maxSize &&
              ...
              g.outerWidth(),
              "img" === a.effect
                ? (g.css({ height: a.maxSize + "px" }),
                  g.find(">img").css({ maxHeight: "100%" }),
                ...
                : a.maxSize < c &&
                  ("stretch" == a.effect
                    ? (g.css({
                      ...
                      g.find("> div").css({ margin: "0 5%" }))
                    : ((c = a.maxSize / c - 0.2),
                      (d = "-50%"),
                      "roundBounce" == a.effect
                        ? ((d = "-75%"), a.text && (d = "75%"))
                        : "win8" == a.effect ||
                          "timer" == a.effect ||
                          "orbit" == a.effect
            ...
            if (f.outerHeight() > b(window).height()) {
              ...
              0 > d && (d = Math.abs(d));
              0 <= d - h && d + h <= x
                ? m - c > b(window).height() / 2 && (d = h)
                : (d = c > m + x - h ? c - m - h : c - m + h);
              n(d);
